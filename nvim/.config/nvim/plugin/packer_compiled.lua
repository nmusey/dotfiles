...
_G.packer_plugins = {
  ["bufferline.nvim"] = {
    loaded = true,
    path = "/Users/nick/.local/share/nvim/site/pack/packer/start/bufferline.nvim",
  ...
  everforest = {
    loaded = true,
    path = "/Users/nick/.local/share/nvim/site/pack/packer/start/everforest",
  ...
  ["lazy-lsp.nvim"] = {
    loaded = true,
    path = "/Users/nick/.local/share/nvim/site/pack/packer/start/lazy-lsp.nvim",
  ...
  nerdtree = {
    loaded = true,
    path = "/Users/nick/.local/share/nvim/site/pack/packer/start/nerdtree",
    url = "https://github.com/preservim/nerdtree"
  },
  ["nerdtree-git-plugin"] = {
    loaded = true,
    path = "/Users/nick/.local/share/nvim/site/pack/packer/start/nerdtree-git-plugin",
  ...
  ["nvim-surround"] = {
    loaded = true,
    path = "/Users/nick/.local/share/nvim/site/pack/packer/start/nvim-surround",
  ...
  ["vim-closer"] = {
    loaded = true,
    path = "/Users/nick/.local/share/nvim/site/pack/packer/start/vim-closer",
